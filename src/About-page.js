                        ...
                        <div className="swiper-wrapper">
                            <div className="advisor-swiper-slide swiper-slide">
                                <div className="advisor-slide-content">
                                    ...
                                    <p className="advisor-award">Professor & Head - Combustion R&D Center, IIT Madras
</p>
                                    <p className="advisor-desi">An accomplished rocket scientist, combustion expert with over
25 years of experience, cofounder of 3 IIT Madras startups.</p>
                            ...
                            <div className="advisor-swiper-slide swiper-slide">
                                <div className="advisor-slide-content">
                                    ...
                                    <p className="advisor-award">(Retd.) GSLV Project Director & ISRO Veteran</p>
                                    <p className="advisor-desi">An accomplished rocket scientist and the Project Director of
                            ...
                            <div className="advisor-swiper-slide swiper-slide">
                                <div className="advisor-slide-content">
                                    ...
                                    <p className="advisor-award">Prof. (Emeritus) - Electronics and Communication Engineering.</p>
                                    <p className="advisor-desi">Project Director of ANUSAT - 1. Over 35 years of experience in
electronics and avionics design.</p>
                            ...
                            <div className="advisor-swiper-slide swiper-slide">
                                <div className="advisor-slide-content">
                                    ...
                                    <p className="advisor-award">Head of Aerospace Industry Development Association of Tamil
Nadu, (Retd.) MD CDG - Boeing, India</p>
                                    <p className="advisor-desi">Accomplished aerospace industry veteran with over 40 years of
                    ...
                    <div className="swiper-wrapper">
                        <div className="business-swiper-slide swiper-slide">
                            <div className="business-slide-content">
                                <p className="business-slide-quote">"With Agnikul, goal is to make space affordable for everyone in India. If you are excited about our journey,”</p>
                               {/* $0 */}
