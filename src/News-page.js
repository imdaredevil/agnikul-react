    ...
    return (
        <div className="body">
            ...
            <div className="news__overall-div">
                <div className="news-swiper swiper-container">
                    <div className="swiper-wrapper">
                        <div className="news__swiper-slide swiper-slide">
                            <img className="news__slide-image" src={newsHolder} />
                            <div id="chennai" className="news__slide-content">
                                <p className="news__slide-title">Chennai-based space tech start-up Agnikul has raised ₹23.4 crores
</p>
                                <p className="news__slide-text">Agnikul, operating out of the National Centre for Combustion Research at IIT Madras,
                is developing a satellite launch vehicle for payload capacity of up to 100 kg</p>
                                <a href="https://www.thehindu.com/news/cities/chennai/chennai-based-space-tech-start-up-agnikul-has-raised-234-crore/article31097822.ece" target="_blank" className="news__slide-link">READ ARTICLE</a>
                            </div>
                        </div>
                        <div className="news__swiper-slide swiper-slide">
                            <img className="news__slide-image" src={newsHolder} />
                ...
                is developing a satellite launch vehicle for payload capacity of up to 100 kg</p>
                    ...
                    <div className="news__swiper-pagination swiper-pagination"></div>
                </div>
